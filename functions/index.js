...
// ============================================================================
// CLOUD FUNCTION: Proxy for football-data.org API (bypasses CORS)
// Endpoint: POST /proxyFootballData
// Body: { token: "your-football-data-token" }
// ============================================================================
const https = require('https');

exports.proxyFootballData = functions.https.onRequest(async (req, res) => {
  // Enable CORS for your deployed site
  ...
  if (!token) {
    res.status(400).json({ error: 'Missing token. Provide { "token": "your-token" }' });
    return;
  }
